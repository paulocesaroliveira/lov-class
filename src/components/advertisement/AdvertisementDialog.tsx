          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div 
                ...
                onClick={() => advertisement.profile_photo_url && handleMediaClick(
                  "image",
                  `https://keqcfrpqctyfxpfoxrkp.supabase.co/storage/v1/object/public/profile_photos/${advertisement.profile_photo_url}`
                )}
              >
